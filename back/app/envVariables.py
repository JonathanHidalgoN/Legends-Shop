...
load_dotenv()
DATABASE_ALEMBIC_URL: str = os.getenv("DATABASE_ALEMBIC_URL", "postgresql://db:1234@$localhost:2345/BD")
DATABASE_URL: str = os.getenv("DATABASE_URL", "postgresql://db:1234@$localhost:2345/BD")
