...
async def getLocationIdByCountryName(
    asyncSession: AsyncSession, countryName: str
) -> int | None:
...
async def getLocationByCountryName(
    asyncSession: AsyncSession, countryName: str
) -> Optional[LocationTable]:
...
async def updateLocation(
    asyncSession: AsyncSession, locationId: int, newCountryName: str
) -> None:
